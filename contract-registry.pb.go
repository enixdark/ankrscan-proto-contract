...
func (x *GetContractsReply) Reset() {
	*x = GetContractsReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetContractsReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetContractsReply) ProtoMessage() {}

func (x *GetContractsReply) ProtoReflect() protoreflect.Message {
	mi := &file_contract_registry_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetContractsReply.ProtoReflect.Descriptor instead.
func (*GetContractsReply) Descriptor() ([]byte, []int) {
	return file_contract_registry_proto_rawDescGZIP(), []int{3}
}

func (x *GetContractsReply) GetContracts() []*Contract {
	if x != nil {
		return x.Contracts
	}
	return nil
...
var file_contract_registry_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x63, 0x74, 0x52, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x22, 0x51,
	0x0a, 0x11, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73, 0x52, 0x65,
	0x70, 0x6c, 0x79, 0x12, 0x3c, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6c, 0x6f,
	...
	0x73, 0x2a, 0x43, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00,
	0x12, 0x09, 0x0a, 0x05, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x53,
	0x43, 0x41, 0x4e, 0x4e, 0x45, 0x44, 0x10, 0x02, 0x12, 0x0c, 0x0a, 0x08, 0x56, 0x45, 0x52, 0x49,
	0x46, 0x49, 0x45, 0x44, 0x10, 0x03, 0x32, 0x73, 0x0a, 0x10, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61,
	0x63, 0x74, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x12, 0x5f, 0x0a, 0x0b, 0x47, 0x65,
	0x74, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x12, 0x28, 0x2e, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x2e, 0x65, 0x78, 0x74, 0x72, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x6f,
	0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x2c, 0x0a, 0x10, 0x63,
...
var file_contract_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_contract_registry_proto_goTypes = []interface{}{
	...
	(*GetContractsReply)(nil),  // 4: com.clover.extractor.GetContractsReply
}
var file_contract_registry_proto_depIdxs = []int32{
	...
	1, // 2: com.clover.extractor.GetContractsReply.contracts:type_name -> com.clover.extractor.Contract
	2, // 3: com.clover.extractor.ContractRegistry.GetContract:input_type -> com.clover.extractor.GetContractRequest
	3, // 4: com.clover.extractor.ContractRegistry.GetContract:output_type -> com.clover.extractor.GetContractReply
...
func file_contract_registry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_contract_registry_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetContractsReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
