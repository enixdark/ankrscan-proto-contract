...
type TokenBalance struct {
	...
	ValueDecimals   int32  `protobuf:"varint,3,opt,name=value_decimals,json=valueDecimals,proto3" json:"value_decimals,omitempty"`
...
func (x *TokenBalance) GetValueDecimals() int32 {
	if x != nil {
...
var file_contract_registry_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x44, 0x65,
