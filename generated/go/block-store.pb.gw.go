...
func RegisterBlockStoreHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BlockStoreServer) error {
	...
	mux.Handle("POST", pattern_BlockStore_Next_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/com.ankrscan.blockstore.BlockStore/Next", runtime.WithHTTPPathPattern("/v1/block/next"))
		if err != nil {
...
func RegisterBlockStoreHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BlockStoreClient) error {
	...
	mux.Handle("POST", pattern_BlockStore_Next_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/com.ankrscan.blockstore.BlockStore/Next", runtime.WithHTTPPathPattern("/v1/block/next"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_BlockStore_Next_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "block", "next"}, ""))
