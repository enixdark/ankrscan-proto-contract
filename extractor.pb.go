...
type BtcBlockHeader struct {
	...
	Difficulty        float32 `protobuf:"fixed32,9,opt,name=difficulty,proto3" json:"difficulty,omitempty"`
...
func (x *BtcBlockHeader) GetDifficulty() float32 {
	if x != nil {
		return x.Difficulty
	}
	return 0
...
type BtcTransaction_ScriptSig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BtcTransaction_ScriptSig) Reset() {
	*x = BtcTransaction_ScriptSig{}
	if protoimpl.UnsafeEnabled {
...
func (x *BtcTransaction_ScriptSig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BtcTransaction_ScriptSig) ProtoMessage() {}

func (x *BtcTransaction_ScriptSig) ProtoReflect() protoreflect.Message {
	mi := &file_extractor_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BtcTransaction_ScriptSig.ProtoReflect.Descriptor instead.
func (*BtcTransaction_ScriptSig) Descriptor() ([]byte, []int) {
	return file_extractor_proto_rawDescGZIP(), []int{4, 0}
}

func (x *BtcTransaction_ScriptSig) GetAsm() string {
	if x != nil {
		return x.Asm
	}
	return ""
...
func (x *BtcTransaction_ScriptSig) GetHex() string {
	if x != nil {
		return x.Hex
	}
	return ""
...
func (x *BtcTransaction_ScriptPubKeyResult) GetAsm() string {
	if x != nil {
		return x.Asm
	}
	return ""
...
func (x *BtcTransaction_ScriptPubKeyResult) GetHex() string {
	if x != nil {
		return x.Hex
	}
	return ""
...
type BtcTransaction_Vin struct {
	...
	ScriptSig *BtcTransaction_ScriptSig `protobuf:"bytes,4,opt,name=script_sig,json=scriptSig,proto3" json:"script_sig,omitempty"`
...
func (x *BtcTransaction_Vin) GetCoinbase() string {
	if x != nil {
		return x.Coinbase
	}
	return ""
...
func (x *BtcTransaction_Vin) GetScriptSig() *BtcTransaction_ScriptSig {
	if x != nil {
		return x.ScriptSig
	}
	return nil
...
func (x *BtcTransaction_Vin) GetSequence() uint32 {
	if x != nil {
		return x.Sequence
	}
	return 0
...
func (x *BtcTransaction_Vin) GetWitness() []string {
	if x != nil {
		return x.Witness
	}
	return nil
...
type BtcTransaction_Vout struct {
	...
	BestBlock     string                             `protobuf:"bytes,1,opt,name=bestBlock,proto3" json:"bestBlock,omitempty"`
	Confirmations int64                              `protobuf:"varint,2,opt,name=confirmations,proto3" json:"confirmations,omitempty"`
	Value         float32                            `protobuf:"fixed32,3,opt,name=value,proto3" json:"value,omitempty"`
	ScriptPubKey  *BtcTransaction_ScriptPubKeyResult `protobuf:"bytes,4,opt,name=script_pub_key,json=scriptPubKey,proto3" json:"script_pub_key,omitempty"`
...
func (*BtcTransaction_Vout) Descriptor() ([]byte, []int) {
	return file_extractor_proto_rawDescGZIP(), []int{4, 3}
}

func (x *BtcTransaction_Vout) GetBestBlock() string {
	if x != nil {
		return x.BestBlock
	}
	return ""
...
func (x *BtcTransaction_Vout) GetConfirmations() int64 {
	if x != nil {
...
func (x *BtcTransaction_Vout) GetValue() float32 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *BtcTransaction_Vout) GetCoinbase() bool {
	if x != nil {
		return x.Coinbase
	}
	return false
...
var file_extractor_proto_rawDesc = []byte{
	...
	0x79, 0x18, 0x09, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0a, 0x64, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75,
	...
	0x6f, 0x6e, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x8b, 0x07, 0x0a, 0x0e, 0x42, 0x74, 0x63,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x56, 0x6f, 0x75, 0x74, 0x52, 0x04, 0x76, 0x6f, 0x75, 0x74, 0x1a, 0x2f,
	...
	0x03, 0x68, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x68, 0x65, 0x78, 0x1a,
	0x85, 0x01, 0x0a, 0x12, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x68, 0x65, 0x78, 0x12, 0x19, 0x0a, 0x08, 0x72, 0x65,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x1a, 0xce, 0x01, 0x0a, 0x03, 0x56, 0x69, 0x6e, 0x12,
	0x1a, 0x0a, 0x08, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x74,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x5d, 0x0a, 0x0e, 0x73,
	0x63, 0x72, 0x69, 0x70, 0x74, 0x5f, 0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04, 0x20,
	...
	0x72, 0x69, 0x70, 0x74, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x6f,
	0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x63, 0x6f,
	0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x22, 0x80, 0x01, 0x0a, 0x08, 0x42, 0x74, 0x63, 0x42, 0x6c,
	...
	0x72, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0xbe, 0x01, 0x0a, 0x0c, 0x42, 0x6c,
	...
	0x6b, 0x42, 0x07, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x2b, 0x0a, 0x10, 0x63, 0x6f,
...
var file_extractor_proto_goTypes = []interface{}{
	...
	(*BtcTransaction_ScriptSig)(nil),          // 7: com.clover.extractor.BtcTransaction.ScriptSig
	(*BtcTransaction_ScriptPubKeyResult)(nil), // 8: com.clover.extractor.BtcTransaction.ScriptPubKeyResult
	(*BtcTransaction_Vin)(nil),                // 9: com.clover.extractor.BtcTransaction.Vin
	(*BtcTransaction_Vout)(nil),               // 10: com.clover.extractor.BtcTransaction.Vout
}
var file_extractor_proto_depIdxs = []int32{
	...
	9,  // 2: com.clover.extractor.BtcTransaction.vin:type_name -> com.clover.extractor.BtcTransaction.Vin
	10, // 3: com.clover.extractor.BtcTransaction.vout:type_name -> com.clover.extractor.BtcTransaction.Vout
	...
	7,  // 8: com.clover.extractor.BtcTransaction.Vin.script_sig:type_name -> com.clover.extractor.BtcTransaction.ScriptSig
	8,  // 9: com.clover.extractor.BtcTransaction.Vout.script_pub_key:type_name -> com.clover.extractor.BtcTransaction.ScriptPubKeyResult
...
func file_extractor_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_extractor_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BtcTransaction_ScriptSig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
