...
func (x *BlockChanged) GetBlockHash() []byte {
	if x != nil {
		return x.BlockHash
	}
	return nil
...
func (x *BlockChanged) GetParentHash() []byte {
	if x != nil {
		return x.ParentHash
	}
	return nil
...
var file_extractor_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x6e, 0x74, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52,
