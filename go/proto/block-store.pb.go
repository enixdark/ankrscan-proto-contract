...
var file_block_store_proto_rawDesc = []byte{
	...
	0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x5e, 0x0a, 0x15, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73,
	...
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x08, 0x72, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0x49, 0x0a, 0x13, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73,
	0x42, 0x79, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x32, 0x0a,
	...
	0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x6c, 0x0a, 0x0b,
	...
	0x09, 0x62, 0x61, 0x74, 0x63, 0x68, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xce, 0x01, 0x0a, 0x09, 0x4e,
...
var file_block_store_proto_goTypes = []interface{}{
	...
	(*BlocksByNumberRequest)(nil),       // 27: ankrscan.blockstore.BlocksByNumberRequest
	(*BlocksByNumberReply)(nil),         // 28: ankrscan.blockstore.BlocksByNumberReply
	(*BlockRangeRequest)(nil),           // 29: ankrscan.blockstore.BlockRangeRequest
	(*BlockConsumer)(nil),               // 30: ankrscan.blockstore.BlockConsumer
	(*NextRequest)(nil),                 // 31: ankrscan.blockstore.NextRequest
	(*NextReply)(nil),                   // 32: ankrscan.blockstore.NextReply
	(*CommitRequest)(nil),               // 33: ankrscan.blockstore.CommitRequest
	(*CommitReply)(nil),                 // 34: ankrscan.blockstore.CommitReply
	(*SeekRequest)(nil),                 // 35: ankrscan.blockstore.SeekRequest
	(*SeekReply)(nil),                   // 36: ankrscan.blockstore.SeekReply
	(*LastCommitRequest)(nil),           // 37: ankrscan.blockstore.LastCommitRequest
	(*LastCommitReply)(nil),             // 38: ankrscan.blockstore.LastCommitReply
	(*LatestBlockHeaderRequest)(nil),    // 39: ankrscan.blockstore.LatestBlockHeaderRequest
	(*LatestBlockHeaderReply)(nil),      // 40: ankrscan.blockstore.LatestBlockHeaderReply
}
var file_block_store_proto_depIdxs = []int32{
	...
	26, // 16: ankrscan.blockstore.BlocksByNumberRequest.requests:type_name -> ankrscan.blockstore.BlockByNumberRequest
	10, // 17: ankrscan.blockstore.BlocksByNumberReply.blocks:type_name -> ankrscan.blockstore.Block
	30, // 18: ankrscan.blockstore.NextRequest.consumer:type_name -> ankrscan.blockstore.BlockConsumer
	10, // 19: ankrscan.blockstore.NextReply.blocks:type_name -> ankrscan.blockstore.Block
	8,  // 20: ankrscan.blockstore.NextReply.commit:type_name -> ankrscan.blockstore.BlockHeader
	8,  // 21: ankrscan.blockstore.NextReply.latest:type_name -> ankrscan.blockstore.BlockHeader
	30, // 22: ankrscan.blockstore.CommitRequest.consumer:type_name -> ankrscan.blockstore.BlockConsumer
	8,  // 23: ankrscan.blockstore.CommitRequest.block:type_name -> ankrscan.blockstore.BlockHeader
	8,  // 24: ankrscan.blockstore.CommitReply.committed:type_name -> ankrscan.blockstore.BlockHeader
	30, // 25: ankrscan.blockstore.SeekRequest.consumer:type_name -> ankrscan.blockstore.BlockConsumer
	8,  // 26: ankrscan.blockstore.SeekReply.committed:type_name -> ankrscan.blockstore.BlockHeader
	30, // 27: ankrscan.blockstore.LastCommitRequest.consumer:type_name -> ankrscan.blockstore.BlockConsumer
	8,  // 28: ankrscan.blockstore.LastCommitReply.committed:type_name -> ankrscan.blockstore.BlockHeader
	8,  // 29: ankrscan.blockstore.LatestBlockHeaderReply.block:type_name -> ankrscan.blockstore.BlockHeader
	15, // 30: ankrscan.blockstore.BlockStore.GetExtractors:input_type -> ankrscan.blockstore.GetExtractorsRequest
	17, // 31: ankrscan.blockstore.BlockStore.UpdateExtractors:input_type -> ankrscan.blockstore.UpdateExtractorsRequest
	16, // 32: ankrscan.blockstore.BlockStore.DeleteExtractors:input_type -> ankrscan.blockstore.DeleteExtractorsRequest
	29, // 33: ankrscan.blockstore.BlockStore.BlockRange:input_type -> ankrscan.blockstore.BlockRangeRequest
	31, // 34: ankrscan.blockstore.BlockStore.Next:input_type -> ankrscan.blockstore.NextRequest
	33, // 35: ankrscan.blockstore.BlockStore.Commit:input_type -> ankrscan.blockstore.CommitRequest
	35, // 36: ankrscan.blockstore.BlockStore.Seek:input_type -> ankrscan.blockstore.SeekRequest
	37, // 37: ankrscan.blockstore.BlockStore.LastCommit:input_type -> ankrscan.blockstore.LastCommitRequest
	27, // 38: ankrscan.blockstore.BlockStore.BlocksByNumber:input_type -> ankrscan.blockstore.BlocksByNumberRequest
	39, // 39: ankrscan.blockstore.BlockStore.LatestBlockHeader:input_type -> ankrscan.blockstore.LatestBlockHeaderRequest
	29, // 40: ankrscan.blockstore.BlockStore.BlockRangeContinuous:input_type -> ankrscan.blockstore.BlockRangeRequest
	18, // 41: ankrscan.blockstore.BlockStore.GetExtractors:output_type -> ankrscan.blockstore.ExtractorConfigs
	18, // 42: ankrscan.blockstore.BlockStore.UpdateExtractors:output_type -> ankrscan.blockstore.ExtractorConfigs
	18, // 43: ankrscan.blockstore.BlockStore.DeleteExtractors:output_type -> ankrscan.blockstore.ExtractorConfigs
	14, // 44: ankrscan.blockstore.BlockStore.BlockRange:output_type -> ankrscan.blockstore.BlockRangeReply
	32, // 45: ankrscan.blockstore.BlockStore.Next:output_type -> ankrscan.blockstore.NextReply
	34, // 46: ankrscan.blockstore.BlockStore.Commit:output_type -> ankrscan.blockstore.CommitReply
	36, // 47: ankrscan.blockstore.BlockStore.Seek:output_type -> ankrscan.blockstore.SeekReply
	38, // 48: ankrscan.blockstore.BlockStore.LastCommit:output_type -> ankrscan.blockstore.LastCommitReply
	28, // 49: ankrscan.blockstore.BlockStore.BlocksByNumber:output_type -> ankrscan.blockstore.BlocksByNumberReply
	40, // 50: ankrscan.blockstore.BlockStore.LatestBlockHeader:output_type -> ankrscan.blockstore.LatestBlockHeaderReply
	14, // 51: ankrscan.blockstore.BlockStore.BlockRangeContinuous:output_type -> ankrscan.blockstore.BlockRangeReply
