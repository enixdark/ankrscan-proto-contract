...
type TokenBalancesWithContractDetailsReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Balances      []*TokenBalanceWithContractDetails `protobuf:"bytes,1,rep,name=balances,proto3" json:"balances,omitempty"`
	NextPageToken []byte                             `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}

func (x *TokenBalancesWithContractDetailsReply) Reset() {
	*x = TokenBalancesWithContractDetailsReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *TokenBalancesWithContractDetailsReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenBalancesWithContractDetailsReply) ProtoMessage() {}

func (x *TokenBalancesWithContractDetailsReply) ProtoReflect() protoreflect.Message {
	mi := &file_token_indexer_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenBalancesWithContractDetailsReply.ProtoReflect.Descriptor instead.
func (*TokenBalancesWithContractDetailsReply) Descriptor() ([]byte, []int) {
	return file_token_indexer_proto_rawDescGZIP(), []int{1}
}

func (x *TokenBalancesWithContractDetailsReply) GetBalances() []*TokenBalanceWithContractDetails {
	if x != nil {
		return x.Balances
	}
	return nil
...
func (x *TokenBalancesWithContractDetailsReply) GetNextPageToken() []byte {
	if x != nil {
...
type TokenBalanceWithContractDetails struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TokenBalanceWithContractDetails) Reset() {
	*x = TokenBalanceWithContractDetails{}
	if protoimpl.UnsafeEnabled {
...
func (x *TokenBalanceWithContractDetails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenBalanceWithContractDetails) ProtoMessage() {}

func (x *TokenBalanceWithContractDetails) ProtoReflect() protoreflect.Message {
	mi := &file_token_indexer_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenBalanceWithContractDetails.ProtoReflect.Descriptor instead.
func (*TokenBalanceWithContractDetails) Descriptor() ([]byte, []int) {
	return file_token_indexer_proto_rawDescGZIP(), []int{3}
}

func (x *TokenBalanceWithContractDetails) GetBlockchainName() string {
	if x != nil {
		return x.BlockchainName
	}
	return ""
...
func (x *TokenBalanceWithContractDetails) GetContractAddress() []byte {
	if x != nil {
...
func (x *TokenBalanceWithContractDetails) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *TokenBalanceWithContractDetails) GetDecimals() uint64 {
	if x != nil {
		return x.Decimals
	}
	return 0
...
func (x *TokenBalanceWithContractDetails) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
func (x *TokenBalanceWithContractDetails) GetHolderAddress() []byte {
	if x != nil {
...
func (x *TokenBalanceWithContractDetails) GetBalance() []byte {
	if x != nil {
		return x.Balance
	}
	return nil
...
var file_token_indexer_proto_rawDesc = []byte{
	...
	,
	...
	0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xfe, 0x01, 0x0a, 0x1f, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x57, 0x69, 0x74, 0x68, 0x43, 0x6f,
	0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x27, 0x0a,
	...
	0x0c, 0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xa1, 0x01, 0x0a, 0x14, 0x54,
	...
	0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x32, 0x8e, 0x01, 0x0a,
	0x0c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x72, 0x12, 0x7e, 0x0a,
	...
	0x3c, 0x2e, 0x61, 0x6e, 0x6b, 0x72, 0x73, 0x63, 0x61, 0x6e, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x72, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x61, 0x6c,
	0x61, 0x6e, 0x63, 0x65, 0x73, 0x57, 0x69, 0x74, 0x68, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63,
	0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x0a, 0x5a,
...
var file_token_indexer_proto_goTypes = []interface{}{
	...
	(*TokenBalancesWithContractDetailsReply)(nil), // 1: ankrscan.tokenindexer.TokenBalancesWithContractDetailsReply
	(*TokenBalancesReply)(nil),                    // 2: ankrscan.tokenindexer.TokenBalancesReply
	(*TokenBalanceWithContractDetails)(nil),       // 3: ankrscan.tokenindexer.TokenBalanceWithContractDetails
...
var file_token_indexer_proto_depIdxs = []int32{
	3, // 0: ankrscan.tokenindexer.TokenBalancesWithContractDetailsReply.balances:type_name -> ankrscan.tokenindexer.TokenBalanceWithContractDetails
	5, // 1: ankrscan.tokenindexer.TokenBalancesReply.balances:type_name -> ankrscan.tokenindexer.TokenBalance
	0, // 2: ankrscan.tokenindexer.TokenIndexer.BalanceByHolder:input_type -> ankrscan.tokenindexer.BalanceByHolderRequest
	1, // 3: ankrscan.tokenindexer.TokenIndexer.BalanceByHolder:output_type -> ankrscan.tokenindexer.TokenBalancesWithContractDetailsReply
...
func file_token_indexer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_token_indexer_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TokenBalancesWithContractDetailsReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_token_indexer_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TokenBalanceWithContractDetails); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
