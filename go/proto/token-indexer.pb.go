...
func (x *CurrencyListRequest) GetBlockchainName() string {
	if x != nil {
		return x.BlockchainName
	}
	return ""
...
func (x *CurrencyListReply) GetCurrencies() []*CurrencyDetailsExtended {
	if x != nil {
		return x.Currencies
	}
	return nil
...
var file_token_indexer_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x73, 0x22, 0x3e, 0x0a, 0x13, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79,
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x62,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x22, 0x63, 0x0a, 0x11, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79,
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x4e, 0x0a, 0x0a, 0x63, 0x75, 0x72,
	0x72, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e,
	0x61, 0x6e, 0x6b, 0x72, 0x73, 0x63, 0x61, 0x6e, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x69, 0x6e,
	0x64, 0x65, 0x78, 0x65, 0x72, 0x2e, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x64, 0x52, 0x0a, 0x63,
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x22, 0x56, 0x0a, 0x11, 0x4c, 0x69, 0x71,
	...
	0x32, 0xc0, 0x02, 0x0a, 0x0c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x65,
...
var file_token_indexer_proto_goTypes = []interface{}{
	...
	(*CurrencyListRequest)(nil),     // 14: ankrscan.tokenindexer.CurrencyListRequest
	(*CurrencyListReply)(nil),       // 15: ankrscan.tokenindexer.CurrencyListReply
...
var file_token_indexer_proto_depIdxs = []int32{
	...
	12, // 7: ankrscan.tokenindexer.CurrencyListReply.currencies:type_name -> ankrscan.tokenindexer.CurrencyDetailsExtended
	...
	5,  // 12: ankrscan.tokenindexer.TokenIndexer.BalanceByHolder:output_type -> ankrscan.tokenindexer.BalancesDetailedReply
	3,  // 13: ankrscan.tokenindexer.TokenIndexer.UsdPrice:output_type -> ankrscan.tokenindexer.UsdPricesReply
	22, // 14: ankrscan.tokenindexer.TokenIndexer.TokenHolders:output_type -> ankrscan.tokenindexer.TokenHoldersReply
...
func file_token_indexer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_token_indexer_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CurrencyListReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
