...
func (x *TokenContractDetails) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *TokenContractDetails) GetDecimals() int32 {
	if x != nil {
		return x.Decimals
	}
	return 0
...
func (x *TokenContractRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
var file_token_indexer_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0x0e, 0x0a, 0x0c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x65,
