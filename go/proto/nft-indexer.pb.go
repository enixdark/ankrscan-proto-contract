...
type NftIndexerConfig struct {
	...
	ParallelFetchCount   int32  `protobuf:"varint,6,opt,name=parallel_fetch_count,json=parallelFetchCount,proto3" json:"parallel_fetch_count,omitempty"`
}
...
func (x *NftIndexerConfig) GetBatchSize() int32 {
	if x != nil {
		return x.BatchSize
	}
	return 0
...
func (x *NftIndexerConfig) GetParallelFetchCount() int32 {
	if x != nil {
...
var file_nft_indexer_proto_rawDesc = []byte{
	...
	0x74, 0x63, 0x68, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52,
